...
foreach($partidos as $partido){
	...
	?>
	<li><a href="<?php echo Yii::app()->request->baseUrl; ?>/partido/view/<?php echo $partido['id']; ?>"><?php echo $partido["fecha"].'('.$campeonato["torneo"].' '.$campeonato["fecha"].'-'.$campeonato["division"].') vs '.$partido["rival"]; ?></a> <?php if(is_user_logged_in()){ ?>
